...
INSERT INTO "new_Transaction" ("amount", "categoryId", "createdAt", "date", "id", "title", "type", "userId") SELECT "amount", "categoryId", "createdAt", "date", "id", "title", "type", "userId" FROM "Transaction";
