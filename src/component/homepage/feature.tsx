  ...
  const features = [
    {
      ...
      description:
        ".با ابزارهای ساده, هزینه‌ها و درآمدهای خود را به راحتی مدیریت کنید",
    },
    {
    ...
    },
    {
      ...
      description:
        "هزینه‌هات رو به‌صورت خودکار در دسته‌های مختلف مثل خوراک، حمل‌ونقل و سرگرمی طبقه‌بندی کن.",
    },
  ];
  return (
